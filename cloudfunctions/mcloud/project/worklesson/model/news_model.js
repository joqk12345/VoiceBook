...
NewsModel.DB_STRUCTURE = {
	_pid: 'string|true',
	NEWS_ID: 'string|false|default=|comment=自动生成ID',

	NEWS_TITLE: 'string|true|comment=标题',
	NEWS_DESC: 'string|false|default=|comment=描述',
	...
	NEWS_ADD_IP: 'string|false|default=',
	NEWS_EDIT_IP: 'string|false|default=',
};
