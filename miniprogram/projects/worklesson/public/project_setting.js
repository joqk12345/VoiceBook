module.exports = { //worklesson
	...
	MEET_NEW_NODE_DAY: [
		{
			mark: 'mark-am', start: '10:00', end: '10:59', limit: 1, isLimit: true, status: 1,
			stat: { succCnt: 0, cancelCnt: 0, adminCancelCnt: 0, }
		},
		{
			mark: 'mark-pm', start: '15:00', end: '16:59', limit: 1, isLimit: true, status: 1,
			stat: { succCnt: 0, cancelCnt: 0, adminCancelCnt: 0, }
		},
		{
			mark: 'mark-pm', start: '18:00', end: '19:59', limit: 1, isLimit: true, status: 1,
			stat: { succCnt: 0, cancelCnt: 0, adminCancelCnt: 0, }
		}
	]
